...
class TalonSRX(BaseMotorController):
    ...
    def configPeakCurrentLimit(self, amps: int, timeoutMs: int):
        ...
        :param timeoutMs:
            ...
            blocking or checking is performed.
        """
        return self.impl.configPeakCurrentLimit(self.handle, amps, timeoutMs)

    def configPeakCurrentDuration(self, milliseconds: int, timeoutMs: int):
        ...
        :param timeoutMs:
            ...
            blocking or checking is performed.
        """
        return self.impl.configPeakCurrentDuration(self.handle, milliseconds, timeoutMs)

    def configContinuousCurrentLimit(self, amps: int, timeoutMs: int):
        ...
        :param timeoutMs:
            ...
            blocking or checking is performed.
        """
        return self.impl.configContinuousCurrentLimit(self.handle, amps, timeoutMs)

    def enableCurrentLimit(self, enable: bool):
        ...
        """
        self.impl.enableCurrentLimit(self.handle, enable);
